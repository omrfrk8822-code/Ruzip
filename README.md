...
| Tip | Açıklama | İndir |
|-----|----------|-------|
| 🏠 Inno Setup | Önerilen. Sağ tık menüsü + dosya ilişkilendirme dahil | [RuZip_Setup_0.1.4.exe](https://github.com/omrfrk8822-code/Ruzip/releases/download/v0.1.4/RuZip_Setup_0.1.4.exe) |
| 📦 MSI | Wix MSI kurulum | [RuZip_0.1.4_x64_tr-TR.msi](https://github.com/omrfrk8822-code/Ruzip/releases/download/v0.1.4/RuZip_0.1.4_x64_tr-TR.msi) |
| 🧳 Portable | Taşınabilir, kurulum gerekmez | [RuZip.exe](https://github.com/omrfrk8822-code/Ruzip/releases/download/v0.1.4/RuZip.exe) |
...
| Tip | Dağıtım | İndir |
|-----|---------|-------|
| 📦 AppImage | Tüm dağıtımlar (Ubuntu, Fedora, Arch, vb.) | [RuZip_0.1.4_amd64.AppImage](https://github.com/omrfrk8822-code/Ruzip/releases/download/v0.1.4/RuZip_0.1.4_amd64.AppImage) |
| 📦 deb | Ubuntu, Debian, Mint, Pop!_OS | [RuZip_0.1.4_amd64.deb](https://github.com/omrfrk8822-code/Ruzip/releases/download/v0.1.4/RuZip_0.1.4_amd64.deb) |

### 🍎 macOS

| Tip | İşlemci | İndir |
|-----|---------|-------|
| 📦 DMG | Apple Silicon (M1, M2, M3, M4) | [RuZip_0.1.4_aarch64.dmg](https://github.com/omrfrk8822-code/Ruzip/releases/download/v0.1.4/RuZip_0.1.4_aarch64.dmg) |
